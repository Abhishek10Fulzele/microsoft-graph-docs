...
$additionalData = [
	...
	'data' => [
			...
			'serverProcessedContent' => [
					'imageSources' => $imageSources1 = new ();
...
$webpartsWebPart1->setImageSources($imageSourcesArray);


				'customMetadata' => $customMetadata1 = new ();
...
$webpartsWebPart1->setCustomMetadata($customMetadataArray);
